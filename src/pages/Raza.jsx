            ...
            <div id='area2'>
                ...
                <div className='estadisticas-raza'>
                    <div className="seccion-raza animacion-hover">
                        ...
                        <p><span className="negrita-raza">Popularidad:</span> {raza["general"]["popularity"]}</p>
                        ...
                        <p><span className="negrita-raza">Esperanza de vida:</span> {raza["general"]["lifespan"]}</p>
                    </div>

                    <div className="seccion-raza animacion-hover">
                        <h3>Físico</h3>
                        <p><span className="negrita-raza">Tamaño:</span> {raza["physical"]["size"]}</p>
                        <p><span className="negrita-raza">Esperanza de vida:</span> {raza["physical"]["lifespan"]}</p>
                        <p><span
                            className="negrita-raza">Frecuencia de babeo:</span> {raza["physical"]["droolingFrequency"]}
                        </p>
                        <p><span className="negrita-raza">Estilo de pelaje:</span> {raza["physical"]["coatStyle"]}</p>
                        <p><span className="negrita-raza">Textura de pelaje:</span> {raza["physical"]["coatTexture"]}</p>
                        <p><span className="negrita-raza">Largo de pelaje:</span> {raza["physical"]["coatLength"]}</p>
                        <p><span className="negrita-raza">Doble capa:</span> {raza["physical"]["doubleCoat"] ? 'Sí' : 'No'}
                        </p>
                    </div>

                    <div className="seccion-raza animacion-hover">
                        <h3>Comportamiento</h3>
                        <p><span className="negrita-raza">Afecto familiar:</span> {raza["behavior"]["familyAffection"]}</p>
                        <p><span
                        ...
                        <p><span className="negrita-raza">Adaptabilidad:</span> {raza["behavior"]["adaptability"]}</p>
                        <p><span
                    ...
                    <div className="seccion-raza animacion-hover">
                        <h3>Cuidados</h3>
                        <p><span className="negrita-raza">Cantidad de muda:</span> {raza["care"]["sheddingAmount"]}</p>
                        <p><span className="negrita-raza">Frecuencia de aseo:</span> {raza["care"]["groomingFrequency"]}
                        </p>
                        <p><span className="negrita-raza">Necesidades de ejercicio:</span> {raza["care"]["exerciseNeeds"]}
                        </p>
                        <p><span
